    ...
    <div className="relative flex flex-col border border-gray-200 dark:border-gray-800 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow bg-white dark:bg-gray-900">
      ...
      <div className="mt-auto flex gap-2">
        ...
        <button
          ...
          className="px-3 py-2 rounded border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
